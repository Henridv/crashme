...
----------------------------------------------------------------------
 ...
 2.41   28-SEP-2005  Edited for easier reading and added some function
                     prototypes.
 2.42   05-OCT-2005
 2.43   17-OCT-2005
 2.44   28-OCT-2005  Add fflush() calls to empty buffers to stdout/logfile
 2.45   13-JUN-2006  Correct data types in my_signal() per 'gcc' on Linux
                       by clearing signal mask as a sigset_t data type.
